...
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="http://rootcave.com/">Root Cave POS</a>
			</div>
	...
	<footer class="footer hidden-print">
      <div class="container">
        <p class="text-muted">You are using <a href="http://rootcave.com/">Root Cave</a> POS All rights reserved.
        </p>
      </div>
    </footer>
	<!-- Scripts -->
